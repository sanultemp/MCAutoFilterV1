    ...
    if 2 < len(message.text) < 50:    
        ...
        if len(btn) > 10: 
            ...
            await message.reply_text(
                f"<b> Here is your request for {message.text}</b>",
    ...
    if (clicked == typed) or (clicked in AUTH_USERS):
        ...
        if query.data.startswith("next"):
            ...
            keyboard = InlineKeyboardMarkup([
                ...
                [InlineKeyboardButton("🔗 JOIN OUR GROUP 🔗", url="https://t.me/MovieCupboard")]
            ])
            ...
            keyboard = InlineKeyboardMarkup([
                [InlineKeyboardButton("BACK", callback_data="start_data"),
                    InlineKeyboardButton("ABOUT", callback_data="about_data")],
                [InlineKeyboardButton("🎥 Movie Cupboard 🎥", url="https://t.me/MovieCupboard")]
            ])
            ...
            keyboard = InlineKeyboardMarkup([
                ...
                [InlineKeyboardButton("Contact Me", url="https://t.me/owner_moviecupboard")]
            ])
